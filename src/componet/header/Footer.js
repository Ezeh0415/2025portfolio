      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
        ...
        <div className="flex flex-col md:items-end gap-2">
          <div className="flex items-center gap-4 mb-1">
            <a
              href="mailto:ezeanwechigozie@gmail.com"
              className="hover:text-indigo-400 transition text-sm flex items-center gap-1"
            >
              <svg
                className="w-4 h-4"
                fill="none"
            ...
            <a
              href="https://github.com/Ezeh0415"
              target="_blank"
            ...
            <a
              href="https://www.linkedin.com/in/ezeanwe-chigozie-49b78a260?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-indigo-400 transition"
            >
